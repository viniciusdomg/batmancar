...
class TelaInicialBatman extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Definições de cor e fonte podem ser personalizadas (usar ThemeData).
    return Scaffold(
      backgroundColor: const Color(0xFF101322),
      appBar: AppBar(
        backgroundColor: Colors.transparent,
        elevation: 0,
        leading: Icon(Icons.shield, color: Color(0xFF2547F4), size: 32),
        centerTitle: true,
        title: Text(
          'Carro do Batman',
            ...
            _GridCard(
              ...
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => TelaControleManual(),
                  ),
                );
              },
            ),
            _GridCard(
              ...
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => TelaFuncoesEspeciais(),
                  ),
                );
              },
            ),
            ...
            _GridCard(
              ...
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => TelaDirecaoAutomatica(),
                  ),
                );
              },
            ),
      ...
      child: Card(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Icon(icon, color: Color(0xFF2547F4), size: 32),
